    ...
    edView.on("keyup", function(e) {
      ...
      if (e.keyCode == 27) {
        ...
        if (str != "") {
            ...
            var process = new BufferedProcess({command:"titanium",args:args,stdout:function(e){console.log(e)}});
            //var process = new BufferedProcess({command:"alloy",args:new Array("new", ppath+"/"+str),stdout:function(e){console.log(e)}});
